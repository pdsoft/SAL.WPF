...
namespace SAL.WPF.ViewModel
{
    ...
    public class EquipmentViewModel : ViewModelBase
    {
        ...
        public static readonly DependencyProperty NameplatePanelProperty =
            DependencyProperty.Register("NameplatePanel", typeof(Page), typeof(EquipmentViewModel), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty SpecificationPanelProperty =
            DependencyProperty.Register("SpecificationPanel", typeof(Page), typeof(EquipmentViewModel), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty AttributePanelProperty =
            DependencyProperty.Register("AttributePanel", typeof(Page), typeof(EquipmentViewModel), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty ProblemPanelProperty =
            DependencyProperty.Register("ProblemPanel", typeof(Page), typeof(EquipmentViewModel), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty AttachmentPanelProperty =
            DependencyProperty.Register("AttachmentPanel", typeof(Page), typeof(EquipmentViewModel), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty CustomerInputPanelProperty =
            DependencyProperty.Register("CustomerInputPanel", typeof(Page), typeof(EquipmentViewModel), new UIPropertyMetadata(null));
